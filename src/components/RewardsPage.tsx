...
export const RewardsPage: React.FC<RewardsPageProps> = ({
  ...
  {
    id: 'restaurant-1',
    title: '20% Off Indian Fusion Meals',
    description: 'Savor modern Indian cuisine at Bombay Bites in Delhi',
    discount: '20%',
    category: 'restaurant',
    partner: 'Bombay Bites',
  ...
  {
    id: 'travel-1',
    title: '10% Off Flights to East Africa',
    description: 'Fly to Nairobi, Kampala, and Dar es Salaam at discounted fares',
    discount: '10%',
    category: 'travel',
    partner: 'AfricaJet',
  ...
  {
    id: 'tools-1',
    title: '40% Off Dev Tools Suite',
    description: 'Access premium coding platforms and cloud IDEs',
    discount: '40%',
    category: 'tools',
    partner: 'CodeCloud',
  ...
  {
    id: 'restaurant-2',
    title: 'Free Jollof with Grilled Chicken Combo',
    description: 'Enjoy a local favorite meal on us!',
    discount: 'Free Item',
    category: 'restaurant',
    partner: 'Mama J\'s Kitchen',
  ...
  {
    id: 'travel-2',
    title: '25% Off Hotel Stays in Sri Lanka',
    description: 'Verified EduStream learners get access to beach resorts and city hotels',
    discount: '25%',
    category: 'travel',
    partner: 'Serene Hotels',
  ...
  {
    id: 'tools-2',
    title: '30% Off Creative Design Software',
    description: 'Get tools for graphic design, animation, and editing',
    discount: '30%',
    category: 'tools',
    partner: 'DesignFlow Africa',
    validUntil: new Date('2025-12-31'),
