...
const Community = () => {
  const communities = [
    ...
    {
      id: 'global-builders',
      title: 'Global Builders Community',
      description: 'Local builders and innovators shaping Bhutan\'s digital future. Connect with fellow Global working on tech projects.',
      platform: 'WhatsApp',
