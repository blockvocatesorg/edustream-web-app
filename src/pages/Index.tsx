          ...
          <div className="max-w-7xl mx-auto text-center space-y-8">
            <div className="space-y-4">
              ...
              <h1 className="text-5xl md:text-6xl font-bold bg-gradient-to-r from-orange-600 via-red-600 to-orange-700 bg-clip-text text-transparent leading-tight">
                Empowering South Asia and Africa to Become the World's First Blockchain-Literate Regions
              </h1>
              <p className="text-xl md:text-2xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
                Transforming education across South Asia and Africa — where culture meets innovation and every learner earns their future.
              </p>
            </div>
            ...
            <Alert className="max-w-2xl mx-auto border-orange-200 bg-orange-50">
              ...
              <AlertDescription className="text-left">
                ...
                Sign in with your Google Account to start your personalized Web3 education journey. 
        ...
        <section className="py-16 px-4 bg-white/50">
          <div className="max-w-7xl mx-auto space-y-8">
            <div className="text-center space-y-2">
              ...
              <p className="text-gray-600">The world's Web3 learning platform</p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <Card className="text-center border-2 border-orange-100">
                ...
                <CardContent>
                  <p className="text-gray-600">
                    Seamless authentication with Google Authentication. 
              ...
              <Card className="text-center border-2 border-green-100">
                ...
                <CardContent>
                  <p className="text-gray-600">
                    Earn EDU tokens and verified Google credentials that unlock free software subscriptions, 
        ...
        <footer className="bg-gray-900 text-white py-12 px-4">
          <div className="max-w-7xl mx-auto text-center space-y-4">
            ...
            <p className="text-gray-400 max-w-2xl mx-auto">
              Bridging tradition and technology across South Asia & Africa with blockchain-powered education.            </p>
              ...
              <AlertDescription>
                ...
                {guestMode && (
                  <span className="block mt-2 text-sm text-orange-600">
                    You're in guest mode. Sign in with Google to save your progress and earn credentials.
                  </span>
                )}
              </AlertDescription>
            </Alert>
